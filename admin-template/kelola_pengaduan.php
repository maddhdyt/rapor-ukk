                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex" style="gap: 10px;">
                                    <a href="../detail_pengaduan.php?id=" class="btn_control secondary text-white" data-toggle="tooltip" data-original-title="Detail"><i class="fa-solid fa-circle-info"></i></a>
                                    <a href="form_validasi.php?id=" class="btn_control primary text-white" data-toggle="tooltip" data-original-title="Tanggapi"><i class="fa-regular fa-comment"></i></a>
                                </div>
